        ...
        >
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group/code h-32">
                ...
                <pre className="relative bg-black/30 rounded-lg p-3 overflow-hidden text-sm text-gray-300 font-mono line-clamp-3 h-full">
                  {snippet.code}
                </pre>
              </div>
            </div>
